...
describe('GeminiService', () => {
  ...
  describe('generateText', () => {
    ...
    it('should throw GeminiError if no content generated', async () => {
      ...
      await expect(geminiService.generateText('Say hello')).rejects.toThrow(GeminiError);
    });
    ...
    it('should handle rate limit errors', async () => {
      ...
      await expect(geminiService.generateText('Say hello')).rejects.toThrow(RateLimitError);
    });
  ...
  describe('generateContentStream', () => {
    it('should handle streaming responses', async () => {
      ...
      const messages = [{ role: 'user' as const, parts: [{ text: 'Say hello' }] }];
  ...
  describe('circuit breaker', () => {
    ...
    it('should reject requests when circuit is open', async () => {
      ...
      await expect(service.generateText('Test')).rejects.toThrow('Circuit breaker is OPEN');
    });
