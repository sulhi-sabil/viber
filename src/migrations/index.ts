  ...
  },
  {
    ...
    up: async () => {
      logger.info(
        ...
        {
          file: '20260110001-fix-sessions-timestamp.sql',
          action: 'up',
  ...
  },
  {
    ...
    up: async () => {
      logger.info(
        ...
        {
          file: '20260110002-add-timestamp-constraints.sql',
          action: 'up',
          location: 'Supabase SQL Editor',
        }
      );
  ...
  },
  {
    ...
    up: async () => {
      logger.info(
        ...
        {
          file: '20260110003-add-asset-entry-relationship.sql',
          action: 'up',
          location: 'Supabase SQL Editor',
        }
      );
  ...
  },
  {
    ...
    up: async () => {
      logger.info(
        ...
        {
          file: '20260110004-add-created-at-indexes.sql',
          action: 'up',
          location: 'Supabase SQL Editor',
        }
      );
