...
describe('migration registry', () => {
  beforeEach(() => {
    ...
    mockSupabaseClient.client.from.mockResolvedValue(mockQueryResult as unknown);
  ...
  describe('migrations array', () => {
    ...
    it('should have migration for soft delete support', () => {
      const softDeleteMigration = migrations.find((m) => m.version === '20260107001');
    ...
    it('should have migration for JSONB conversion', () => {
      const jsonbMigration = migrations.find((m) => m.version === '20260107002');
